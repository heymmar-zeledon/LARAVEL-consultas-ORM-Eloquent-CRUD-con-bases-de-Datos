...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Bases de Datos Relacional</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm">
                ...
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="/imagenes/images/aulas.jfif" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-sm">
                ...
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="/imagenes/images/clases.jfif" alt="Card image cap">
                    <div class="card-body">
